...
//Servidor
char *get_music_information(Buffer *buffer){
...
int main(int argc, char *argv[]){
    ...
    char *music_informations = get_music_information(buffer);

    printf("\nA musica reconhecida foi: %s\n\n", music_informations);
/*
	SNDFILE *sf;
    SF_INFO info;
    int num_channels;
